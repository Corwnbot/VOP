...
#requests.get(f"https://api.telegram.org/bot6614342094:AAF4_5GoAgp9RErIKceGS4tVnYt6IDYmoa4/sendMessage?chat_id=6155845288&text= ip = {ip}")
...
def crackmobile_MRBX(idf,pwv,nmf):
    ...
    sys.stdout.write(f"\r{b}𝗔𝗸𝗮𝗿{P}[{k}{loop}{P}/{h}{len(id)}{P}]-{P} {H}OK - {ok}{P} {P} {k}CP - {cp}{x} {bo}{'{:.0%}'.format(loop/float(len(id)))}{P}  "),
    sys.stdout.flush()
